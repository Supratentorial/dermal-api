        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Practitioners_HumanName_NameId",
                        column: x => x.NameId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patients_Practitioners_GeneralPractitionerId",
                        column: x => x.GeneralPractitionerId,
                        principalTable: "Practitioners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Patients_HumanName_NameId",
                        column: x => x.NameId,
                        principalTable: "HumanName",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactPoint_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContactPoint_Practitioners_PractitionerId",
                        column: x => x.PractitionerId,
                        principalTable: "Practitioners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReferralRequests_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    ReferralRequestId = table.Column<int>(type: "int", nullable: true),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Media_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Media_ReferralRequests_ReferralRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactPoint_PatientId",
                table: "ContactPoint",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactPoint_PractitionerId",
                table: "ContactPoint",
                column: "PractitionerId");

            migrationBuilder.CreateIndex(
                name: "IX_Media_PatientId",
                table: "Media",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_Media_ReferralRequestId",
                table: "Media",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Practitioners_NameId",
                table: "Practitioners",
                column: "NameId");

            migrationBuilder.CreateIndex(
                name: "IX_ReferralRequests_PatientId",
